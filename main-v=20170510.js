...
/*			this.poseidonStarted= 0;
		...
		*/
		...
		_offlineresult: function(){
			...
			if (toolong==0){
				Game._makeNotice("clock", "Offline production", "You were offline for " +offlinetimeb+ ". While you were offline you gained " + Beautify(Math.floor(extraprod)) + " drops ("+ this.offlineperc+"% of drops per second) and aliens drained " + Beautify(Math.floor(extradrain)) + " drops", 0, 0,15000);
			} else {
				Game._makeNotice("clock", "Offline production", "You were offline for " +offlinetimea+ ", but you can only get drops for "+offlinetimeb+". While you were offline you gained " + Beautify(Math.floor(extraprod)) + " drops ("+ this.offlineperc+"% of drops per second) and aliens drained " + Beautify(Math.floor(extradrain)) + " drops", 0, 0,15000);
			}
		},
...
//forgot an id
	...
	{id:406, sort: "mouse", name: "Air Mouse", filename: "upgrades", cx:0 , cy:-1500, cost: 50000000000000000000000, required: 100000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"Clicking gains +2% of your drops per second."},
	{id:407, sort: "mouse", name: "Water Mouse", filename: "upgrades", cx:-60 , cy:-1500, cost: 5000000000000000000000000, required: 1000000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"Clicking gains +2% of your drops per second."},
	{id:408, sort: "mouse", name: "Fire Mouse", filename: "upgrades", cx:-120 , cy:-1500, cost: 500000000000000000000000000, required: 10000000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"Clicking gains +2% of your drops per second."},
	
	{id:409, sort: "hand", name: "Too many fingers!", filename: "upgrades", cx:-180 , cy:-1500, cost: 100000000000000000, required: 340, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"Each click and Helping Hand gain 5,000,000 drops per click or second for each building owned."},
	{id:409, sort: "hand", name: "I can't look at those fingers any more!", filename: "upgrades", cx:-240 , cy:-1500, cost: 1000000000000000000, required: 380, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"Each click and Helping Hand gain 5,000,000 drops per click or second for each building owned."},
	{id:410, sort: "hand", name: "I'm a finger addict!", filename: "upgrades", cx:-300 , cy:-1500, cost: 10000000000000000000, required: 420, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"Each click and Helping Hand gain 5,000,000 drops per click or second for each building owned."},
	
	{id:411, sort: "building", name: "Colossal Pipette", filename: "upgrades", cx:-360 , cy:-1500, cost:5000000000000000000, required: 300, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"Each pipette will produce twice as many drops."},
	{id:412, sort: "building", name: "Massive Pipette", filename: "upgrades", cx:-420 , cy:-1500, cost:500000000000000000000, required: 350, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"Each pipette will produce twice as many drops."},
	{id:413, sort: "building", name: "Gigantic Pipette", filename: "upgrades", cx:-480 , cy:-1500, cost:50000000000000000000000, required: 400, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"Each pipette will produce twice as many drops."},
	
	{id:414, sort: "building", name: "Colossal Air Dryer", filename: "upgrades", cx:0 , cy:-1560, cost:55000000000000000000, required: 300, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"Each air dryer will produce twice as many drops."},
	{id:415, sort: "building", name: "Massive Air Dryer", filename: "upgrades", cx:-60 , cy:-1560, cost:5500000000000000000000, required: 350, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"Each air dryer will produce twice as many drops."},
	{id:416, sort: "building", name: "Gigantic Air Dryer", filename: "upgrades", cx:-120 , cy:-1560, cost:550000000000000000000000, required: 400, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"Each air dryer will produce twice as many drops."},
	
	{id:417, sort: "building", name: "Colossal Bucket", filename: "upgrades", cx:-180 , cy:-1560, cost:600000000000000000000, required: 300, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"Each bucket will produce twice as many drops."},
	{id:418, sort: "building", name: "Massive Bucket", filename: "upgrades", cx:-240 , cy:-1560, cost:60000000000000000000000, required: 350, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"Each bucket will produce twice as many drops."},
	{id:419, sort: "building", name: "Gigantic Bucket", filename: "upgrades", cx:-300 , cy:-1560, cost:6000000000000000000000000, required: 400, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"Each bucket will produce twice as many drops."},

	{id:420, sort: "building", name: "Colossal Raindance", filename: "upgrades", cx:-360 , cy:-1560, cost:6500000000000000000000, required: 300, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"Each raindance will produce twice as many drops."},
	{id:421, sort: "building", name: "Massive Raindance", filename: "upgrades", cx:-420 , cy:-1560, cost:650000000000000000000000, required: 350, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"Each raindance will produce twice as many drops."},
	{id:422, sort: "building", name: "Gigantic Raindance", filename: "upgrades", cx:-480 , cy:-1560, cost:65000000000000000000000000, required: 400, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"Each raindance will produce twice as many drops."},
	
	{id:423, sort: "building", name: "Colossal Faucet", filename: "upgrades", cx:0 , cy:-1620, cost:70000000000000000000000, required: 300, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"Each faucet will produce twice as many drops."},
	{id:424, sort: "building", name: "Massive Faucet", filename: "upgrades", cx:-60 , cy:-1620, cost:7000000000000000000000000, required: 350, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"Each faucet will produce twice as many drops."},
	{id:425, sort: "building", name: "Gigantic Faucet", filename: "upgrades", cx:-120 , cy:-1620, cost:700000000000000000000000000, required: 400, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"Each faucet will produce twice as many drops."},
	
	{id:426, sort: "building", name: "Colossal Garden Hose", filename: "upgrades", cx:-180 , cy:-1620, cost:1000000000000000000000000, required: 300, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"Each garden hose will produce twice as many drops."},
	{id:427, sort: "building", name: "Massive Garden Hose", filename: "upgrades", cx:-240 , cy:-1620, cost:100000000000000000000000000, required: 350, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"Each garden hose will produce twice as many drops."},
	{id:428, sort: "building", name: "Gigantic Garden Hose", filename: "upgrades", cx:-300 , cy:-1620, cost:10000000000000000000000000000, required: 400, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"Each garden hose will produce twice as many drops."},
	
	{id:429, sort: "building", name: "Colossal Truck", filename: "upgrades", cx:-360 , cy:-1620, cost:16500000000000000000000000, required: 300, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"Each truck will produce twice as many drops."},
	{id:430, sort: "building", name: "Massive Truck", filename: "upgrades", cx:-420 , cy:-1620, cost:1650000000000000000000000000, required: 350, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"Each truck will produce twice as many drops."},
	{id:431, sort: "building", name: "Gigantic Truck", filename: "upgrades", cx:-480 , cy:-1620, cost:165000000000000000000000000000, required: 400, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"Each truck will produce twice as many drops."},
	
	{id:432, sort: "building", name: "Colossal Fire Hose", filename: "upgrades", cx:0 , cy:-1680, cost:255000000000000000000000000, required: 300, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"Each fire hose will produce twice as many drops."},
	{id:433, sort: "building", name: "Massive Fire Hose", filename: "upgrades", cx:-60 , cy:-1680, cost:25500000000000000000000000000, required: 350, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"Each fire hose will produce twice as many drops."},
	{id:434, sort: "building", name: "Gigantic Fire Hose", filename: "upgrades", cx:-120 , cy:-1680, cost:2550000000000000000000000000000, required: 400, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"Each fire hose will produce twice as many drops."},
	
	{id:435, sort: "building", name: "Colossal Mine", filename: "upgrades", cx:-180 , cy:-1680, cost:3750000000000000000000000000, required: 300, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"Each ice mine will produce twice as many drops."},
	{id:436, sort: "building", name: "Massive Mine", filename: "upgrades", cx:-240 , cy:-1680, cost:375000000000000000000000000000, required: 350, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"Each ice mine will produce twice as many drops."},
	{id:437, sort: "building", name: "Gigantic Mine", filename: "upgrades", cx:-300 , cy:-1680, cost:37500000000000000000000000000000, required: 400, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"Each ice mine will produce twice as many drops."},
	
	{id:438, sort: "building", name: "Colossal Spaceship", filename: "upgrades", cx:-360 , cy:-1680, cost:50000000000000000000000000000, required: 300, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"Each spaceship will produce twice as many drops."},
	{id:439, sort: "building", name: "Massive Spaceship", filename: "upgrades", cx:-420 , cy:-1680, cost:5000000000000000000000000000000, required: 350, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"Each spaceship will produce twice as many drops."},
	{id:440, sort: "building", name: "Gigantic Spaceship", filename: "upgrades", cx:-480 , cy:-1680, cost:500000000000000000000000000000000, required: 400, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"Each spaceship will produce twice as many drops."},
	
	{id:441, sort: "building", name: "Colossal Wormhole", filename: "upgrades", cx:0 , cy:-1740, cost:700000000000000000000000000000, required: 300, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"Each wormhole will produce twice as many drops."},
	{id:442, sort: "building", name: "Massive Wormhole", filename: "upgrades", cx:-60 , cy:-1740, cost:70000000000000000000000000000000, required: 350, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"Each wormhole will produce twice as many drops."},
	{id:443, sort: "building", name: "Gigantic Wormhole", filename: "upgrades", cx:-120 , cy:-1740, cost:7000000000000000000000000000000000, required: 400, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"Each wormhole will produce twice as many drops."},
	
	{id:444, sort: "building", name: "Colossal River", filename: "upgrades", cx:-180 , cy:-1740, cost:8500000000000000000000000000000, required: 300, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"Each river will produce twice as many drops."},
	{id:445, sort: "building", name: "Massive River", filename: "upgrades", cx:-240 , cy:-1740, cost:850000000000000000000000000000000, required: 350, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"Each river will produce twice as many drops."},
	{id:446, sort: "building", name: "Gigantic River", filename: "upgrades", cx:-300 , cy:-1740, cost:85000000000000000000000000000000000, required: 400, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"Each river will produce twice as many drops."},
	
	{id:447, sort: "building", name: "Colossal Collider", filename: "upgrades", cx:-360 , cy:-1740, cost:105000000000000000000000000000000, required: 300, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"Each large H-O collider will produce twice as many drops."},
	{id:448, sort: "building", name: "Massive Collider", filename: "upgrades", cx:-420 , cy:-1740, cost:10500000000000000000000000000000000, required: 350, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"Each large H-O collider will produce twice as many drops."},
	{id:449, sort: "building", name: "Gigantic Collider", filename: "upgrades", cx:-480 , cy:-1740, cost:1050000000000000000000000000000000000, required: 400, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"Each large H-O collider will produce twice as many drops."}
