...
var Game = {
		...
		specialsActive: 0,
		specialsDuration:15000,
		prayerbonus: 1,
		crazyscientistMult: 1,
		cpsToDisplay: 0,
		specials200Active: 0,
		specials150Active: 0,
		mouseoverButton:0,
		...
		clickSoundOptionButton: undefined,
		...
		zoominput: undefined,
		bankboost: undefined,
		currentPrayerButton: undefined,
		specialsImage: undefined,
		specialsTitle: undefined,
		specialsDiv: undefined,
		specialsBar: undefined,
		...
		init: function(_buildings, _upgrades, _achievements) {
			...
			this.clickSoundOptionButton = $('#clickSoundOption');
			...
			this.bankboost = $('#bankboost');
			this.currentPrayerButton = $('#currentPrayerButton');
			this.specialsImage = $('#specialsImage');
			this.specialsTitle = $('#specialsTitle');
			this.specialsDiv = $('#specialsDiv');
			this.specialsBar = $('#specialsBar');
			this.buyAllUpgradesButton = $('#buyAllUpgradesButton');
			...
			this.mtneexprogress.hover(function() {
				...
				$('#popover').html('<table><tr><td><p class="popovertitle">Mtn Eew: '+Game.achievementsPerc+'%</p><p>您所获得的成就的百分比是您的Mt Eew的百分比</p><p>越来越多的Mt Eew，科学家们疯狂的工作变得越来越好。 所有疯狂的科学家每秒增加你的额外水滴数 '+Game.crazyscientistsboost+'%</p></td></tr></table>');
			...
			this.buyAllUpgradesButton.click(function(){
				var toSpend = self.drops_in_bank;
				var notBoughtUpgrades = self.upgrades_sorted.filter(function( obj ) { return obj.bought == 0; });
				notBoughtUpgrades = notBoughtUpgrades.sort(function(a, b){return a.cost-b.cost});
				
				$.each(notBoughtUpgrades, function(i, upgrade) {
					if((upgrade.button.css("display") != "none")&&(upgrade.cost<=toSpend)){
						upgrade.buy();
			...
			this.knowhowbackbutton.click(function(){
				self.reload = 1;
			...
			this.clickSoundOptionButton.click(function(){
				var buttonText = self.clickSoundOptionButton.text();
				if (buttonText == "Clickstorm and Wrath sound: off"){
					self.clickSoundOption = 1;
					self.clickSoundOptionButton.text("Clickstorm and Wrath sound: on");
				} else if (buttonText == "Clickstorm and Wrath sound: on"){
					self.clickSoundOption = 0;
					self.clickSoundOptionButton.text("Clickstorm and Wrath sound: off");
				}
			});
			...
			this.weatherstationDivActiveButton.click(function(){
			...
			this.weatherstationImage.hover(function(){
				if(!self.weatherstationImage.hasClass("hoverdrop")){
					self.weatherstationImage.addClass("hoverdrop");
				}
			}, function() {
				// on mouseout
				self.weatherstationImage.removeClass("dropover");
				self.weatherstationImage.removeClass("hoverdrop");
				if(!self.weatherstationImage.hasClass("outdrop")){
					self.weatherstationImage.addClass("outdrop");
					window.setTimeout(function(){self.weatherstationImage.removeClass("outdrop");self.weatherstationImage.removeClass("dropover");}, 1000);
				}
			});
			...
			this.poseidonImage.hover(function(){
				if(!self.poseidonImage.hasClass("hoverdrop")){
					self.poseidonImage.addClass("hoverdrop");
				}
			}, function() {
				// on mouseout
				self.poseidonImage.removeClass("dropover");
				self.poseidonImage.removeClass("hoverdrop");
				if(!self.poseidonImage.hasClass("outdrop")){
					self.poseidonImage.addClass("outdrop");
					window.setTimeout(function(){self.poseidonImage.removeClass("outdrop");self.poseidonImage.removeClass("dropover");}, 1000);
				}
			});
			...
			this.currentPrayerButton.click(function(){
				self._prayerDivClick();
			});
		...
		_prayerSelected:function(id){
			...
			this.prayerbonus = 1;
			if (this.prayers[8].selected == 1){
				this.prayerbonus += 0.10;
			}else if (this.prayers[12].selected == 1){
				this.prayerbonus += 0.20;
			}else if (this.prayers[14].selected == 1){
				this.prayerbonus += 0.40;
			}else if (this.prayers[15].selected == 1){
				this.prayerbonus += 1
			}
			
			this.crazyscientistMult = 1;
			if(this.prayers[1].selected==1){
				this.crazyscientistMult	+= 0.10;		
			} else if(this.prayers[5].selected==1){
				this.crazyscientistMult	+= 0.20;		
			}else if(this.prayers[13].selected==1){
				this.crazyscientistMult	+= 0.40;		
			}
			...
			this.currentPrayerButton.html("Current prayer:<br />"+this.prayers[id].name);
...
/*			this.poseidonStarted= 0;
		...
		*/
		...
		_cloudclicked:function(){
			...
			this.showCloudTimer = window.setTimeout(function(){self.cloudjclicked =0;self._showcloud();}, (nextcl+3000));
			

			var randOutcome = Math.floor((Math.random() * 100) + 1);
			
			if ((randOutcome>=1)&&(randOutcome<=96)){
				if ((randOutcome>=1)&&(randOutcome<=38)){
					this._cloudGivesDrops();
				}else if ((randOutcome>=39)&&(randOutcome<=76)){
					this._cloudGivesStorm();
				}else if (randOutcome==77){
						if (this.buildings[0].quantity>=200){
							this._startSpecial200(0);
						}else if (this.buildings[0].quantity>=150){
							this._startSpecial150(0);
						}else if (this.buildings[0].quantity>=100){
							this._startSpecial(0);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==78){
						if (this.buildings[1].quantity>=200){
							this._startSpecial200(1);
						}else if (this.buildings[1].quantity>=150){
							this._startSpecial150(1);
						}else if (this.buildings[1].quantity>=100){
							this._startSpecial(1);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==79){
						if (this.buildings[2].quantity>=200){
							this._startSpecial200(2);
						}else if (this.buildings[2].quantity>=150){
							this._startSpecial150(2);
						}else if (this.buildings[2].quantity>=100){
							this._startSpecial(2);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==80){
						if (this.buildings[3].quantity>=200){
							this._startSpecial200(3);
						}else if (this.buildings[3].quantity>=150){
							this._startSpecial150(3);
						}else if (this.buildings[3].quantity>=100){
							this._startSpecial(3);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==81){
						if (this.buildings[4].quantity>=200){
							this._startSpecial200(4);
						}else if (this.buildings[4].quantity>=150){
							this._startSpecial150(4);
						}else if (this.buildings[4].quantity>=100){
							this._startSpecial(4);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==82){
						if (this.buildings[5].quantity>=200){
							this._startSpecial200(5);
						}else if (this.buildings[5].quantity>=150){
							this._startSpecial150(5);
						}else if (this.buildings[5].quantity>=100){
							this._startSpecial(5);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==83){
						if (this.buildings[6].quantity>=200){
							this._startSpecial200(6);
						}else if (this.buildings[6].quantity>=150){
							this._startSpecial150(6);
						}else if (this.buildings[6].quantity>=100){
							this._startSpecial(6);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==84){
						if (this.buildings[7].quantity>=200){
							this._startSpecial200(7);
						}else if (this.buildings[7].quantity>=150){
							this._startSpecial150(7);
						}else if (this.buildings[7].quantity>=100){
							this._startSpecial(7);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==85){
						if (this.buildings[8].quantity>=200){
							this._startSpecial200(8);
						}else if (this.buildings[8].quantity>=150){
							this._startSpecial150(8);
						}else if (this.buildings[8].quantity>=100){
							this._startSpecial(8);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==86){
						if (this.buildings[9].quantity>=200){
							this._startSpecial200(9);
						}else if (this.buildings[9].quantity>=150){
							this._startSpecial150(9);
						}else if (this.buildings[9].quantity>=100){
							this._startSpecial(9);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==87){
						if (this.buildings[10].quantity>=200){
							this._startSpecial200(10);
						}else if (this.buildings[10].quantity>=150){
							this._startSpecial150(10);
						}else if (this.buildings[10].quantity>=100){
							this._startSpecial(10);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==88){
						if (this.buildings[11].quantity>=200){
							this._startSpecial200(11);
						}else if (this.buildings[11].quantity>=150){
							this._startSpecial150(11);
						}else if (this.buildings[11].quantity>=100){
							this._startSpecial(11);
						}else{
							this._cloudGivesStorm();
						}
				}else if (randOutcome==89){
						if (this.buildings[12].quantity>=200){
							this._startSpecial200(12);
						}else if (this.buildings[12].quantity>=150){
							this._startSpecial150(12);
						}else if (this.buildings[12].quantity>=100){
							this._startSpecial(12);
						}else{
							this._cloudGivesDrops();
						}
				}else if (randOutcome==90){
						if (this.buildings[13].quantity>=200){
							this._startSpecial200(13);
						}else if (this.buildings[13].quantity>=150){
							this._startSpecial150(13);
						}else if (this.buildings[13].quantity>=100){
							this._startSpecial(13);
						}else{
							this._cloudGivesStorm();
						}
				}else if ((randOutcome>=91)&&(randOutcome<=96)){
		...
		_startSpecial: function(num){
			var self = this;
			this.specialsImage.css({'background':'transparent url("images/png/'+ this.buildings[num].name +'.png") no-repeat right center'});
			if(num!=13){
				this.specialsTitle.text(this.buildings[num].name+" overdrive");
			}else{
					this.specialsTitle.text("Collider overdrive");
			}
			this.specialsBar.css({'width':'150'});
			this.specialsDiv.show();
			if (this.specialsActive==0){
				this.specialsActive=num+1;
				this._stopSpecial(num);	
				this._makeNotice(this.buildings[num].name, "Special!", this.buildings[num].name+"s are in overdrive and give you "+this.buildings[num].quantity+" times your drops per second for "+ this.specialsDuration/1000+" seconds!",0,0,0);
			}
			self.cps();
		},
		
		_startSpecial150: function(num){
			var self = this;
			this.specialsImage.css({'background':'transparent url("images/png/'+ this.buildings[num].name +'.png") no-repeat right center'});
			if(num!=13){
				this.specialsTitle.text(this.buildings[num].name+" overdrive");
			...
			this.specialsBar.css({'width':'150'});
			this.specialsDiv.show();
			if (this.specials150Active==0){
				this.specials150Active=num+1;
				this._stopSpecial(num);	
				this._makeNotice(this.buildings[num].name, "Special!", this.buildings[num].name+"s are in overdrive and give you "+this.buildings[num].quantity*10+" times your drops per second for "+ this.specialsDuration/1000+" seconds!",0,0,0);
			}
			self.cps();
		},
		
		_startSpecial200: function(num){
			var self = this;
			this.specialsImage.css({'background':'transparent url("images/png/'+ this.buildings[num].name +'.png") no-repeat right center'});
			if(num!=13){
				this.specialsTitle.text(this.buildings[num].name+" overdrive");
			...
			this.specialsBar.css({'width':'150'});
			this.specialsDiv.show();
			if (this.specials200Active==0){
				this.specials200Active=num+1;
				this._stopSpecial(num);	
				this._makeNotice(this.buildings[num].name, "Special!", this.buildings[num].name+"s are in overdrive and give you "+this.buildings[num].quantity*100+" times your drops per second for "+ this.specialsDuration/1000+" seconds!",0,0,0);
			}
			self.cps();
		},
		
		_stopSpecial: function(num){
			...
			function frame() { 
				...
				if (i>=(self.specialsDuration/10)){
					clearInterval(interv);
					self.specialsActive=0;
					self.specials150Active=0;
					self.specials200Active=0;
					self.specialsBar.css({'width':'150px'});
					self.specialsDiv.hide();
					self.cps();
				} else{
					var w = 150-(150/(self.specialsDuration/10)*i)+"px";
					self.specialsBar.css({'width':w});
					i++;
				}
				...
				if (self.cloudvisible == 1){
					...
					if ((i==100)||(self.cloudjclicked==1)){
							...
							if (self.cloudjclicked==0){
								...
								if((self.weatherstationLevel>0)&&(self.weatherstationactive==1)){
		...
		_hidecloud: function(){
			...
			if (this.cloudvisible==1){
				...
				this.showCloudTimer = window.setTimeout(function(){self._showcloud();}, (nextcl+3000));
		...
		_getsavetxt: function(){
			...
			savetxt = savetxt + "|";
			savetxt += this.weatherstationactive;
			savetxt = savetxt + "|";
			savetxt += this.clickSoundOption;
			savetxt += "|end";
			return savetxt;
		},
		...
		_load: function(){
			...
			this.showCloudTimer = window.setTimeout(function(){_self._showcloud();}, nextcl);
		...
		_loadv010: function(la){
				...
				if(la[26].charAt(i)=="1"){
					...
					if (upgrade.sort=="mouse"){
						...
						if (upgrade.other==3){
							...
							_self.specialsDuration = _self.specialsDuration *2;
			...
			this._calcPercentageMultiplier();
				...
				if(la[29].charAt(i)=="1"){
					...
					if (this.sort=="unlock"){
						...
						if (this.id==8||this.id==9){
							...
							_self.specialsDuration = _self.specialsDuration * 1.05;
						}
					}
		...
		_loadv0115:function(la){
			this.weatherstationactive = parseFloat(la[72]);
			if (this.weatherstationactive==0){
				...
				this.weatherstationDivActiveButton.text("Disable");
				this.weatherstationDivActiveText.text("The weather station is enabled.");
				this.verbodDiv.hide();
			}
			this.clickSoundOption = parseFloat(la[73]);
			if(this.clickSoundOption==0){
				this.clickSoundOptionButton.text("Clickstorm and Wrath sound: off");
			} else {
				this.clickSoundOptionButton.text("Clickstorm and Wrath sound: on");
			}
		},
		...
		_calcscboost: function(){
			var boost = 0;
			var dboost = 100;
			for(var i = 0; i<this.crazyscientistnum; i++){
				if(Game.prayers[1].selected==1){
					dboost = dboost + (dboost*((Game.lemonade*(10/100))/100)*1.10);
				} else if (Game.prayers[5].selected==1){
					dboost = dboost + (dboost*((Game.lemonade*(10/100))/100)*1.20);
				} else if(Game.prayers[13].selected==1){
					dboost = dboost + (dboost*((Game.lemonade*(10/100))/100)*1.40);
				} else {
					dboost = dboost + (dboost*((Game.lemonade*(10/100))/100));
				}
			}
			boost = (dboost - 100).toFixed(2);
			return boost;
		},
		...
		_offlineresult: function(){
			...
			this.cpsToDisplay = this.cps_cur - (this.cps_cur*percDrain/100);
			var n = Date.now();
			...
			var toolong = 0;
			var offlinetimea = msToTime(diff);
			...
			if (this.alienDrain==0){
				...
				extraprod += this.cps_cur*(diff/1000)*(this.offlineperc/100);
			}else {
				extraprod += this.cpsToDisplay*(diff/1000)*(this.offlineperc/100);
				
			}
			
			this.drops_in_bank += extraprod;
			this.total_drops_produced += extraprod;
			this.total_ever += extraprod;
			
			$.each(this.buildings, function(i, building) {
				building.produceOffline(diff);
			});
			...
			if (toolong==0){
				Game._makeNotice("clock", "离线生产", "你离开了" +offlinetimeb+ ". 当你离线时，你获得了 " + Beautify(Math.floor(extraprod)) + " 水滴 ("+ this.offlineperc+"% 水滴/秒) 被外星人倒掉 " + Beautify(Math.floor(extradrain)) + " 水滴", 0, 0,15000);
			} else {
				Game._makeNotice("clock", "离线生产", "你离开了" +offlinetimea+ ", 但是你能得到的水滴数量为 "+offlinetimeb+"。 当你离线时，你获得了" + Beautify(Math.floor(extraprod)) + " 水滴 ("+ this.offlineperc+"% 水滴/秒) ，被外星人倒掉 " + Beautify(Math.floor(extradrain)) + " 水滴", 0, 0,15000);
			}
		},
		...
		_tick: function(diff) {
			...
			if ((this.sunvisible==1)&&(this.drops_in_ocean>(this.sunloss/1000*diff))){
				...
				if (this.alienDrain==0){
					...
					var percDrain = this.alienNumber*this.alienDrainPerc;
						this.cpsToDisplay = this.cps_cur - (this.cps_cur*percDrain/100);
						var txt = Beautify(this.cpsToDisplay.toFixed(0)) + " drained by " + Math.round(percDrain) + "%";
		...
		_getPerc:function(){
			var DropsBonus = [
				{Limit:895429615305069300000000, Bonus:100},{Limit:792806586866086600000000, Bonus:99},{Limit:701069885589140500000000, Bonus:98},{Limit:619159333722712200000000, Bonus:97},{Limit:546108599233516100000000, Bonus:96},
				{Limit:481037737554191600000000, Bonus:95},{Limit:423146257234581240000000, Bonus:94},{Limit:371706677629111700000000, Bonus:93},{Limit:326058548384867100000000, Bonus:92},{Limit:285602902059438200000000, Bonus:91},
				{Limit:249797112696685560000000, Bonus:90},{Limit:218150134624229060000000, Bonus:89},{Limit:190218097110817420000000, Bonus:88},{Limit:165600231836712060000000, Bonus:87},{Limit:143935111387793220000000, Bonus:86},
				{Limit:124897178186158980000000, Bonus:85},{Limit:108193544418400890000000, Bonus:84},{Limit:93561044619315940000000, Bonus:83},{Limit:80763523615333430000000, Bonus:82},{Limit:69589343530126590000000, Bonus:81},
				{Limit:59849094506439210000000, Bonus:80},{Limit:51373494704737670000000, Bonus:79},{Limit:44011466002515740000000, Bonus:78},{Limit:37628372639504774000000, Bonus:77},{Limit:32104410835214565000000, Bonus:76},
				{Limit:27333138147645726000000, Bonus:75},{Limit:23220132047135960000000, Bonus:74},{Limit:19681767848550770000000, Bonus:73},{Limit:16644106779792821000000, Bonus:72},{Limit:14041885566231883000000, Bonus:71},
				{Limit:11817599480465212000000, Bonus:70},{Limit:9920671346084658000000, Bonus:69},{Limit:8306699494096991000000, Bonus:68},{Limit:6936778152528157000000, Bonus:67},{Limit:5776884204716740000000, Bonus:66},
				{Limit:4797324681010433000000, Bonus:65},{Limit:3972239753131712300000, Bonus:64},{Limit:3279156381453603300000, Bonus:63},{Limit:2698588123869216000000, Bonus:62},{Limit:2213676951864406700000, Bonus:61},
				{Limit:1809873235795386800000, Bonus:60},{Limit:1474650358185208300000, Bonus:59},{Limit:1197250692008858400000, Bonus:58},{Limit:968459941329148800000, Bonus:57},{Limit:780407085140222500000, Bonus:56},
				{Limit:626387392708140700000, Bonus:55},{Limit:500706190877047850000, Bonus:54},{Limit:398541261515392350000, Bonus:53},{Limit:315821931263133900000, Bonus:52},{Limit:249123086734693860000, Bonus:51},
				{Limit:195572507034328200000, Bonus:50},{Limit:152770052525706600000, Bonus:49},{Limit:118717384915664850000, Bonus:48},{Limit:91757019488523120000, Bonus:47},{Limit:70519626362998270000, Bonus:46},
				{Limit:53878604515772420000, Bonus:45},{Limit:40911050578149786000, Bonus:44},{Limit:53878604515772420000, Bonus:43},{Limit:23127577557875340000, Bonus:42},{Limit:17207401025641026000, Bonus:41},
				{Limit:12707388120196856000, Bonus:40},{Limit:9310757851967834000, Bonus:39},{Limit:6765811783780036000, Bonus:38},{Limit:4873763662273663000, Bonus:37},{Limit:3478609346528894500, Bonus:36},
				{Limit:2458736461986831400, Bonus:35},{Limit:1720011062295265800, Bonus:34},{Limit:1190112520884487200, Bonus:33},{Limit:813918209914834700, Bonus:32},{Limit:549766551724137900, Bonus:31},
				{Limit:366451025462807230, Bonus:30},{Limit:240818941573998050, Bonus:29},{Limit:155867505885345250, Bonus:28},{Limit:99246114928149460, Bonus:27},{Limit:62088171641031896, Bonus:26},
				{Limit:38108188628928600, Bonus:25},{Limit:22910743724384880, Bonus:24},{Limit:13467145613480130, Bonus:23},{Limit:7723618886955972, Bonus:22},{Limit:4311578947368420, Bonus:21},
				{Limit:2336276859014280, Bonus:20},{Limit:1224880286215950, Bonus:19},{Limit:619036127056620, Bonus:18},{Limit:300239975158032, Bonus:17},{Limit:139013933454240, Bonus:16},
				{Limit:61054982558010, Bonus:15},{Limit:25239592216020, Bonus:14},{Limit:9726655034460, Bonus:13},{Limit:3452271214392, Bonus:12},{Limit:1111111111110, Bonus:11},
				{Limit:317733228540, Bonus:10},{Limit:78536544840, Bonus:9},{Limit:16148168400, Bonus:8},{Limit:2612138802, Bonus:7},{Limit:305175780, Bonus:6},
				{Limit:22369620, Bonus:5},{Limit:797160, Bonus:4},{Limit:25000, Bonus:3},{Limit:10000, Bonus:2},{Limit:1500, Bonus:1}
			];
			var ret = 0;
			for (i = 0; i < DropsBonus.length; i++) { 
				if (this.drops_in_bank > DropsBonus[i].Limit){
					ret = DropsBonus[i].Bonus;
					break;
				}
			}
		...
		_tickother: function() {
			...
			this.firstStart.text(firstDayDef + " 天 " + firstHourDef +" 小时 " + firstMinDef + " 分钟 " + firstSecDef + " 秒前");
			...
			this.runStart.text(runDayDef + " 天 " + runHourDef +" 小时 " + runMinDef + " 分钟 " + runSecDef + " 秒前");
		...
		_calcPercentageMultiplier: function(){
			var BoughtUpgrades = Game.upgrades_sorted.filter(function( obj ) { return obj.bought == 1; });
			var percentagemultiplier = 0;
			$.each(BoughtUpgrades, function(i, upgrade) {
				if (["multi","ocean","multiknowhow"].indexOf(upgrade.sort) !== -1){
					percentagemultiplier += upgrade.perc;
				}
			});
		...
		cps: function() {
			...
			this.crazyscientistsboost = Game._calcscboost();
			...
			$.each(this.buildings, function(i, building) {
				...
				$.each(BoughtUpgrades, function(i, upgrade) {
					if(upgrade.effecton==building.name){
						if (upgrade.other==0){
							building.curproduction *= upgrade.multiplier;
						}
						else if (upgrade.other == "all"){
							building.curproduction += (buildingQuantity*upgrade.multiplier);
						}
					}
					if ((upgrade.sort=="alientech")&& (upgrade.building == building.id)){
						building.curproduction += (building.curproduction*((Game.buildings[upgrade.pip].quantity/upgrade.pipnum)/100*Game.alientechStrength));
					}
					if ((upgrade.sort=="alientechb")&&(upgrade.building==building.id)){
						building.curproduction += (building.curproduction*((Game.buildings[upgrade.pip].quantity/upgrade.pipnum)/100*Game.alientechStrength));
					}
					if (upgrade.sort=="crazyscientist"){
						building.curproduction = building.curproduction + (building.curproduction*((Game.lemonade*(10/100))/100)* Game.crazyscientistMult);
					}
					if (upgrade.sort=="collaboration"){
						if (upgrade.building==building.id){
							building.curproduction += ((building.curproduction/100*5)*Game.buildings[upgrade.pipnum-1].quantity);
						}
						else if (upgrade.pipnum==building.id){
							building.curproduction += ((building.curproduction/100*0.1)*Game.buildings[upgrade.building-1].quantity);
						}
					}
				...
				if((Game.prayers[3].selected==1)&&(building.id==2)){
					building.curproduction += (building.curproduction/100*buildingQuantity*2);
				}
				
				if (Game.totalmultiplier != 0){
					building.curproduction += (building.curproduction/100*Game.totalmultiplier);
					
				}
				
				if (self.storm==1){
					building.curproduction *= 7;
				}
				if (self.turbo==1){
					building.curproduction *= 30;
				}
				if ((self.knowhow>0)&&(self.useknowhow==1)){
					building.curproduction += (building.curproduction/100*(self.knowhow/100*self.knowhowPerc));
				}
				
				if (self.waterLevel!=1){
					building.curproduction *= self.waterLevel;
				}
				
				building.curproduction = building.curproduction * Game.prayerbonus;
								
				if(Game.specialsActive!=0){
					var num = Game.specialsActive-1;
					building.curproduction *= Game.buildings[num].quantity;				
				}
				
				if(Game.specials150Active!=0){
					var num = Game.specials150Active-1;
					building.curproduction *= Game.buildings[num].quantity*10;				
				}
				
				if(Game.specials200Active!=0){
					var num = Game.specials200Active-1;
					building.curproduction *= Game.buildings[num].quantity*100;				
				}
						...
						this.button = $("<button class='building'><span class='buildingquantity'>"+this.quantity+"</span> <span class='buildingname'>???</span>\n<span class='buildingcost'>"+Beautify(this.cost)+"</span></button></br>").css({'background':'#C5CAE9 url("images/webp/question.webp") no-repeat right center'})
									.hover(function() {
										...
										if(self.shown==1){
											...
											var posX = tempX;
											var posY = self.button.position().top;
										...
										//$('#popover').hide();
										setTimeout(function(){if(Game.mouseoverButton==0){$('#popover').hide();}}, 1000);
									  })
			...
			if((this.active==1)&&(this.bought==0)&&(Game.drops_in_bank>=this.cost)){
				...
				if (this.sort=="mouse"){
					...
					if(this.other==3){
						...
						Game.specialsDuration = Game.specialsDuration *2;
					}else{
				...
				if (["multi","ocean","multiknowhow"].indexOf(this.sort) !== -1){
					Game.totalmultiplier += this.perc;
				}
				...
				this.button = $("<button class='knowhowupgradebutton'></button>").css({'background':'transparent url("images/png/question.png") no-repeat center center'})
								.hover(function() {
									//if(self.shown==1){
										...
										$('#popoverk').html('<table><tr><td><div style="border:2px solid white; border-radius:4px; width:60px; height:60px; background-image:(images/png/' + self.filename + '.png); background-position:'+pos+'">&nbsp;</div></td><td><p class="popovertitle">'+self.name+'</p><p>Cost: '+Beautify(Math.floor(self.cost))+' experience points</p><p>'+self.description+'</p></td></tr></table>').css({'top':posY, 'left':posX}).show();
...
var _buildings = [
	{id: 1, name: "帮手", cost: 15, production: 0.1},
	{id: 2, name: "吸管", cost: 100, production: 1},
	{id: 3, name: "空气干燥机", cost: 1100, production: 10},
	{id: 4, name: "桶", cost: 12000, production: 50},
	{id: 5, name: "祈雨舞", cost: 130000, production: 250},
	{id: 6, name: "水龙头", cost: 1400000,	production: 1500},
	{id: 7, name: "花园软管", cost: 20000000, production: 8000},
	{id: 8, name: "卡车", cost: 330000000, production: 50000},
	{id: 9, name: "消防水带", cost: 5100000000, production: 250000},
	{id: 10, name: "冰矿", cost: 75000000000, production: 1500000},
	{id: 11, name: "飞船", cost: 1000000000000, production: 10000000},
	{id: 12, name: "虫洞", cost: 14000000000000, production: 65000000},
	{id: 13, name: "河流", cost: 170000000000000, production: 450000000},
	{id: 14, name: "大型H-O碰撞机", cost: 2100000000000000, production: 3000000000}
];

var _upgrades = [
	
	{id:1, sort: "mouse", name: "纸鼠标", filename: "upgrades", cx:0 , cy:0, cost: 50000, required: 1000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:2, sort: "mouse", name: "棉鼠标", filename: "upgrades", cx:-60 , cy:0, cost: 5000000, required: 100000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:3, sort: "mouse", name: "皮革鼠标", filename: "upgrades", cx:-120 , cy:0, cost: 500000000, required: 10000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:4, sort: "mouse", name: "木鼠标",  filename: "upgrades", cx:-180 , cy:0, cost: 50000000000, required: 1000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:5, sort: "mouse", name: "铁鼠标", filename: "upgrades", cx:-240 , cy:0, cost: 5000000000000, required: 100000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:6, sort: "mouse", name: "银鼠标", filename: "upgrades", cx:-300 , cy:0, cost: 500000000000000, required: 10000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:7, sort: "mouse", name: "金鼠标", filename: "upgrades", cx:-360 , cy:0, cost: 50000000000000000, required: 1000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:8, sort: "mouse", name: "钻石鼠标", filename: "upgrades", cx:-420 , cy:0, cost: 5000000000000000000, required: 100000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},
	{id:9, sort: "mouse", name: "铂鼠标", filename: "upgrades", cx:-480 , cy:0, cost: 500000000000000000000, required: 10000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 1, other:0, description:"点击收益 +1% 水滴每秒。"},

	{id:10, sort: "hand", name: "两只手", filename: "upgrades", cx:0 , cy:-60, cost: 100, required: 1, effecton: "Helping hand", effect: 0, multiplier: 2, perc: 0,  other:0, description:"每次点击和帮手都是两倍效率。"},
	{id:11, sort: "hand", name: "Injury Prevention", filename: "upgrades", cx:-60 , cy:-60, cost: 500, required: 1, effecton: "Helping hand", effect: 0, multiplier: 2, perc: 0,  other:0, description:"每次点击和帮手都是两倍效率。"},
	{id:12, sort: "hand", name: "Clicking With All Fingers", filename: "upgrades", cx:-120 , cy:-60, cost: 10000, required: 10, effecton: "Helping hand", effect: 0, multiplier: 2, perc: 0,  other:0, description:"每次点击和帮手都是两倍效率。"},
	{id:13, sort: "hand", name: "A Lot Of Fingers", filename: "upgrades", cx:-180 , cy:-60, cost: 100000, required: 20, effecton: "Helping hand", effect: 0, multiplier: 0.1, perc: 0,  other: "all", description:"每个点击和帮手每次/每秒获得0.1水滴对每个建筑。"},
	...
	{id:21, sort: "hand", name: "AARGH I'm Drowning In Fingers!", filename: "upgrades", cx:-480 , cy:-240, cost: 10000000000000000, required: 320, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"每个点击和帮助手每个点击/每秒获得5,000,000滴，每个建筑。"},

	{id:22, sort: "building", name: "Bigger Pipette", filename: "upgrades", cx:0 , cy:-120, cost:1000, required: 1, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:23, sort: "building", name: "Longer Pipette", filename: "upgrades", cx:-60 , cy:-120, cost:5000, required: 5, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:24, sort: "building", name: "Faster Pipette", filename: "upgrades", cx:-120 , cy:-120, cost:50000, required: 25, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:25, sort: "building", name: "Better Pipette", filename: "upgrades", cx:-180 , cy:-120, cost:5000000, required: 50, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:26, sort: "building", name: "Stronger Pipette", filename: "upgrades", cx:-240 , cy:-120, cost:500000000, required: 100, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:27, sort: "building", name: "Larger Pipette", filename: "upgrades", cx:-300 , cy:-120, cost:50000000000, required: 150, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:28, sort: "building", name: "Giant Pipette", filename: "upgrades", cx:-360 , cy:-120, cost:50000000000000, required: 200, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:29, sort: "building", name: "Atomic Pipette", filename: "upgrades", cx:-420 , cy:-120, cost:50000000000000000, required: 250, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:30, sort: "building", name: "Bigger Air Dryer", filename: "upgrades", cx:0 , cy:-180, cost:11000, required: 1, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:31, sort: "building", name: "Longer Air Dryer", filename: "upgrades", cx:-60 , cy:-180, cost:55000, required: 5, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:32, sort: "building", name: "Faster Air Dryer", filename: "upgrades", cx:-120 , cy:-180, cost:550000, required: 25, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:33, sort: "building", name: "Better Air Dryer", filename: "upgrades", cx:-180 , cy:-180, cost:55000000, required: 50, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:34, sort: "building", name: "Stronger Air Dryer", filename: "upgrades", cx:-240 , cy:-180, cost:5500000000, required: 100, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:35, sort: "building", name: "Larger Air Dryer", filename: "upgrades", cx:-300 , cy:-180, cost:550000000000, required: 150, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:36, sort: "building", name: "Giant Air Dryer", filename: "upgrades", cx:-360 , cy:-180, cost:550000000000000, required: 200, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:37, sort: "building", name: "Atomic Air Dryer", filename: "upgrades", cx:-420 , cy:-180, cost:550000000000000000, required: 250, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:38, sort: "building", name: "Bigger Bucket", filename: "upgrades", cx:0 , cy:-240, cost:120000, required: 1, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:39, sort: "building", name: "Longer Bucket", filename: "upgrades", cx:-60 , cy:-240, cost:600000, required: 5, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:40, sort: "building", name: "Faster Bucket", filename: "upgrades", cx:-120 , cy:-240, cost:6000000, required: 25, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:41, sort: "building", name: "Better Bucket", filename: "upgrades", cx:-180 , cy:-240, cost:600000000, required: 50, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:42, sort: "building", name: "Stronger Bucket", filename: "upgrades", cx:-240 , cy:-240, cost:60000000000, required: 100, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:43, sort: "building", name: "Larger Bucket", filename: "upgrades", cx:-300 , cy:-240, cost:6000000000000, required: 150, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:44, sort: "building", name: "Giant Bucket", filename: "upgrades", cx:-360 , cy:-240, cost:6000000000000000, required: 200, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:45, sort: "building", name: "Atomic Bucket", filename: "upgrades", cx:-420 , cy:-240, cost:6000000000000000000, required: 250, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:46, sort: "building", name: "Bigger Raindance", filename: "upgrades", cx:0 , cy:-300, cost:1300000, required: 1, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:47, sort: "building", name: "Longer Raindance", filename: "upgrades", cx:-60 , cy:-300, cost:6500000, required: 5, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:48, sort: "building", name: "Faster Raindance", filename: "upgrades", cx:-120 , cy:-300, cost:65000000, required: 25, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:49, sort: "building", name: "Better Raindance", filename: "upgrades", cx:-180 , cy:-300, cost:6500000000, required: 50, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:50, sort: "building", name: "Stronger Raindance", filename: "upgrades", cx:-240 , cy:-300, cost:650000000000, required: 100, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:51, sort: "building", name: "Larger Raindance", filename: "upgrades", cx:-300 , cy:-300, cost:65000000000000, required: 150, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:52, sort: "building", name: "Giant Raindance", filename: "upgrades", cx:-360 , cy:-300, cost:65000000000000000, required: 200, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:53, sort: "building", name: "Atomic Raindance", filename: "upgrades", cx:-420 , cy:-300, cost:65000000000000000000, required: 250, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:54, sort: "building", name: "Bigger Faucet", filename: "upgrades", cx:0 , cy:-360, cost:14000000, required: 1, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:55, sort: "building", name: "Longer Faucet", filename: "upgrades", cx:-60 , cy:-360, cost:70000000, required: 5, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:56, sort: "building", name: "Faster Faucet", filename: "upgrades", cx:-120 , cy:-360, cost:700000000, required: 25, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:57, sort: "building", name: "Better Faucet", filename: "upgrades", cx:-180 , cy:-360, cost:70000000000, required: 50, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:58, sort: "building", name: "Stronger Faucet", filename: "upgrades", cx:-240 , cy:-360, cost:7000000000000, required: 100, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:59, sort: "building", name: "Larger Faucet", filename: "upgrades", cx:-300 , cy:-360, cost:700000000000000, required: 150, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:60, sort: "building", name: "Giant Faucet", filename: "upgrades", cx:-360 , cy:-360, cost:700000000000000000, required: 200, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:61, sort: "building", name: "Atomic Faucet", filename: "upgrades", cx:-420 , cy:-360, cost:700000000000000000000, required: 250, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:62, sort: "building", name: "Bigger Garden Hose", filename: "upgrades", cx:0 , cy:-420, cost:200000000, required: 1, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:63, sort: "building", name: "Longer Garden Hose", filename: "upgrades", cx:-60 , cy:-420, cost:1000000000, required: 5, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:64, sort: "building", name: "Faster Garden Hose", filename: "upgrades", cx:-120 , cy:-420, cost:10000000000, required: 25, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:65, sort: "building", name: "Better Garden Hose", filename: "upgrades", cx:-180 , cy:-420, cost:1000000000000, required: 50, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:66, sort: "building", name: "Stronger Garden Hose", filename: "upgrades", cx:-240 , cy:-420, cost:100000000000000, required: 100, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:67, sort: "building", name: "Larger Garden Hose", filename: "upgrades", cx:-300 , cy:-420, cost:10000000000000000, required: 150, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:68, sort: "building", name: "Giant Garden Hose", filename: "upgrades", cx:-360 , cy:-420, cost:10000000000000000000, required: 200, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:69, sort: "building", name: "Atomic Garden Hose", filename: "upgrades", cx:-420 , cy:-420, cost:10000000000000000000000, required: 250, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:70, sort: "building", name: "Bigger Truck", filename: "upgrades", cx:0 , cy:-480, cost:3300000000, required: 1, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:71, sort: "building", name: "Longer Truck", filename: "upgrades", cx:-60 , cy:-480, cost:16500000000, required: 5, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:72, sort: "building", name: "Faster Truck", filename: "upgrades", cx:-120 , cy:-480, cost:165000000000, required: 25, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:73, sort: "building", name: "Better Truck", filename: "upgrades", cx:-180 , cy:-480, cost:16500000000000, required: 50, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:74, sort: "building", name: "Stronger Truck", filename: "upgrades", cx:-240 , cy:-480, cost:1650000000000000, required: 100, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:75, sort: "building", name: "Larger Truck", filename: "upgrades", cx:-300 , cy:-480, cost:165000000000000000, required: 150, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:76, sort: "building", name: "Giant Truck", filename: "upgrades", cx:-360 , cy:-480, cost:165000000000000000000, required: 200, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:77, sort: "building", name: "Atomic Truck", filename: "upgrades", cx:-420 , cy:-480, cost:165000000000000000000000, required: 250, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:78, sort: "building", name: "Bigger Fire Hose", filename: "upgrades", cx:0 , cy:-540, cost:51000000000, required: 1, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:79, sort: "building", name: "Longer Fire Hose", filename: "upgrades", cx:-60 , cy:-540, cost:255000000000, required: 5, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:80, sort: "building", name: "Faster Fire Hose", filename: "upgrades", cx:-120 , cy:-540, cost:2550000000000, required: 25, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:81, sort: "building", name: "Better Fire Hose", filename: "upgrades", cx:-180 , cy:-540, cost:255000000000000, required: 50, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:82, sort: "building", name: "Stronger Fire Hose", filename: "upgrades", cx:-240 , cy:-540, cost:25500000000000000, required: 100, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:83, sort: "building", name: "Larger Fire Hose", filename: "upgrades", cx:-300 , cy:-540, cost:2550000000000000000, required: 150, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:84, sort: "building", name: "Giant Fire Hose", filename: "upgrades", cx:-360 , cy:-540, cost:2550000000000000000000, required: 200, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:85, sort: "building", name: "Atomic Fire Hose", filename: "upgrades", cx:-420 , cy:-540, cost:2550000000000000000000000, required: 250, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:""},
	{id:86, sort: "building", name: "Bigger Mine", filename: "upgrades", cx:0 , cy:-600, cost:750000000000, required: 1, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:87, sort: "building", name: "Longer Mine", filename: "upgrades", cx:-60 , cy:-600, cost:3750000000000, required: 5, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:88, sort: "building", name: "Faster Mine", filename: "upgrades", cx:-120 , cy:-600, cost:37500000000000, required: 25, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:89, sort: "building", name: "Better Mine", filename: "upgrades", cx:-180 , cy:-600, cost:3750000000000000, required: 50, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:90, sort: "building", name: "Stronger Mine", filename: "upgrades", cx:-240 , cy:-600, cost:375000000000000000, required: 100, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:91, sort: "building", name: "Larger Mine", filename: "upgrades", cx:-300 , cy:-600, cost:37500000000000000000, required: 150, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:92, sort: "building", name: "Giant Mine", filename: "upgrades", cx:-360 , cy:-600, cost:37500000000000000000000, required: 200, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:93, sort: "building", name: "Atomic Mine", filename: "upgrades", cx:-420 , cy:-600, cost:37500000000000000000000000, required: 250, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:94, sort: "building", name: "Bigger Spaceship", filename: "upgrades", cx:0 , cy:-660, cost:10000000000000, required: 1, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:95, sort: "building", name: "Longer Spaceship", filename: "upgrades", cx:-60 , cy:-660, cost:50000000000000, required: 5, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:96, sort: "building", name: "Faster Spaceship", filename: "upgrades", cx:-120 , cy:-660, cost:500000000000000, required: 25, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:97, sort: "building", name: "Better Spaceship", filename: "upgrades", cx:-180 , cy:-660, cost:50000000000000000, required: 50, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:98, sort: "building", name: "Stronger Spaceship", filename: "upgrades", cx:-240 , cy:-660, cost:5000000000000000000, required: 100, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:99, sort: "building", name: "Larger Spaceship", filename: "upgrades", cx:-300 , cy:-660, cost:500000000000000000000, required: 150, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:100, sort: "building", name: "Giant Spaceship", filename: "upgrades", cx:-360 , cy:-660, cost:500000000000000000000000, required: 200, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:101, sort: "building", name: "Atomic Spaceship", filename: "upgrades", cx:-420 , cy:-660, cost:500000000000000000000000000, required: 250, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:102, sort: "building", name: "Bigger Wormhole", filename: "upgrades", cx:0 , cy:-720, cost:140000000000000, required: 1, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:103, sort: "building", name: "Longer Wormhole", filename: "upgrades", cx:-60 , cy:-720, cost:700000000000000, required: 5, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:104, sort: "building", name: "Faster Wormhole", filename: "upgrades", cx:-120 , cy:-720, cost:7000000000000000, required: 25, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:105, sort: "building", name: "Better Wormhole", filename: "upgrades", cx:-180 , cy:-720, cost:700000000000000000, required: 50, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:106, sort: "building", name: "Stronger Wormhole", filename: "upgrades", cx:-240 , cy:-720, cost:70000000000000000000, required: 100, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:107, sort: "building", name: "Larger Wormhole", filename: "upgrades", cx:-300 , cy:-720, cost:7000000000000000000000, required: 150, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:108, sort: "building", name: "Giant Wormhole", filename: "upgrades", cx:-360 , cy:-720, cost:7000000000000000000000000, required: 200, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:109, sort: "building", name: "Atomic Wormhole", filename: "upgrades", cx:-420 , cy:-720, cost:7000000000000000000000000000, required: 250, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:110, sort: "building", name: "Bigger River", filename: "upgrades", cx:0 , cy:-780, cost:1700000000000000, required: 1, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:111, sort: "building", name: "Longer River", filename: "upgrades", cx:-60 , cy:-780, cost:8500000000000000, required: 5, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:112, sort: "building", name: "Faster River", filename: "upgrades", cx:-120 , cy:-780, cost:85000000000000000, required: 25, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:113, sort: "building", name: "Better River", filename: "upgrades", cx:-180 , cy:-780, cost:8500000000000000000, required: 50, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:114, sort: "building", name: "Stronger River", filename: "upgrades", cx:-240 , cy:-780, cost:850000000000000000000, required: 100, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:115, sort: "building", name: "Larger River", filename: "upgrades", cx:-300 , cy:-780, cost:85000000000000000000000, required: 150, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:116, sort: "building", name: "Giant River", filename: "upgrades", cx:-360 , cy:-780, cost:85000000000000000000000000, required: 200, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:117, sort: "building", name: "Atomic River", filename: "upgrades", cx:-420 , cy:-780, cost:85000000000000000000000000000, required: 250, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:118, sort: "building", name: "Bigger Collider", filename: "upgrades", cx:0 , cy:-840, cost:21000000000000000, required: 1, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:119, sort: "building", name: "Longer Collider", filename: "upgrades", cx:-60 , cy:-840, cost:105000000000000000, required: 5, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:120, sort: "building", name: "Faster Collider", filename: "upgrades", cx:-120 , cy:-840, cost:1050000000000000000, required: 25, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:121, sort: "building", name: "Better Collider", filename: "upgrades", cx:-180 , cy:-840, cost:105000000000000000000, required: 50, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:122, sort: "building", name: "Stronger Collider", filename: "upgrades", cx:-240 , cy:-840, cost:10500000000000000000000, required: 100, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:123, sort: "building", name: "Larger Collider", filename: "upgrades", cx:-300 , cy:-840, cost:1050000000000000000000000, required: 150, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:124, sort: "building", name: "Giant Collider", filename: "upgrades", cx:-360 , cy:-840, cost:1050000000000000000000000000, required: 200, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:125, sort: "building", name: "Atomic Collider", filename: "upgrades", cx:-420 , cy:-840, cost:1050000000000000000000000000000, required: 250, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},

	{id:126, sort: "multi", name: "第一生命！", filename: "upgrades", cx:0 , cy:-900, cost: 1000000, required: 50000, effecton: 0, effect: 0, multiplier: 0, perc: 1,  other: 0, description:"额外水滴生产: +1%"},
...
//forgot an id
	...
	{id:406, sort: "mouse", name: "空气鼠标", filename: "upgrades", cx:0 , cy:-1500, cost: 50000000000000000000000, required: 100000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"点击收益 +2% 水滴每秒。"},
	{id:407, sort: "mouse", name: "水鼠标", filename: "upgrades", cx:-60 , cy:-1500, cost: 5000000000000000000000000, required: 1000000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"点击收益 +2% 水滴每秒。"},
	{id:408, sort: "mouse", name: "火鼠标", filename: "upgrades", cx:-120 , cy:-1500, cost: 500000000000000000000000000, required: 10000000000000000000000, effecton: "mouse", effect: -1, multiplier: 0, perc: 2, other:0, description:"点击收益 +2% 水滴每秒。"},
	
	{id:409, sort: "hand", name: "Too many fingers!", filename: "upgrades", cx:-180 , cy:-1500, cost: 100000000000000000, required: 340, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"每个点击和帮助手每个点击/每秒获得5,000,000滴，每个建筑。"},
	{id:409, sort: "hand", name: "I can't look at those fingers any more!", filename: "upgrades", cx:-240 , cy:-1500, cost: 1000000000000000000, required: 380, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"每个点击和帮助手每个点击/每秒获得5,000,000滴，每个建筑。"},
	{id:410, sort: "hand", name: "I'm a finger addict!", filename: "upgrades", cx:-300 , cy:-1500, cost: 10000000000000000000, required: 420, effecton: "Helping hand", effect: 0, multiplier: 5000000, perc: 0,  other: "all", description:"每个点击和帮助手每个点击/每秒获得5,000,000滴，每个建筑。"},
	
	{id:411, sort: "building", name: "Colossal Pipette", filename: "upgrades", cx:-360 , cy:-1500, cost:5000000000000000000, required: 300, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:412, sort: "building", name: "Massive Pipette", filename: "upgrades", cx:-420 , cy:-1500, cost:500000000000000000000, required: 350, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	{id:413, sort: "building", name: "Gigantic Pipette", filename: "upgrades", cx:-480 , cy:-1500, cost:50000000000000000000000, required: 400, effecton: "Pipette", effect: 1, multiplier: 2, perc: 0,  other: 0, description:"每个吸管将产生两倍的水滴。"},
	
	{id:414, sort: "building", name: "Colossal Air Dryer", filename: "upgrades", cx:0 , cy:-1560, cost:55000000000000000000, required: 300, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:415, sort: "building", name: "Massive Air Dryer", filename: "upgrades", cx:-60 , cy:-1560, cost:5500000000000000000000, required: 350, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	{id:416, sort: "building", name: "Gigantic Air Dryer", filename: "upgrades", cx:-120 , cy:-1560, cost:550000000000000000000000, required: 400, effecton: "Air dryer", effect: 2, multiplier: 2, perc: 0,  other: 0, description:"每个空气干燥器将产生两倍的水滴。"},
	
	{id:417, sort: "building", name: "巨大的桶", filename: "upgrades", cx:-180 , cy:-1560, cost:600000000000000000000, required: 300, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:418, sort: "building", name: "大桶", filename: "upgrades", cx:-240 , cy:-1560, cost:60000000000000000000000, required: 350, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},
	{id:419, sort: "building", name: "巨型桶", filename: "upgrades", cx:-300 , cy:-1560, cost:6000000000000000000000000, required: 400, effecton: "Bucket", effect: 3, multiplier: 2, perc: 0,  other: 0, description:"每个桶将产生两倍的滴。"},

	{id:420, sort: "building", name: "巨大的降雨", filename: "upgrades", cx:-360 , cy:-1560, cost:6500000000000000000000, required: 300, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	{id:421, sort: "building", name: "Massive Raindance", filename: "upgrades", cx:-420 , cy:-1560, cost:650000000000000000000000, required: 350, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:""},
	{id:422, sort: "building", name: "Gigantic Raindance", filename: "upgrades", cx:-480 , cy:-1560, cost:65000000000000000000000000, required: 400, effecton: "Raindance", effect: 4, multiplier: 2, perc: 0,  other: 0, description:"每个雨天都会产生两倍的水滴。"},
	
	{id:423, sort: "building", name: "Colossal Faucet", filename: "upgrades", cx:0 , cy:-1620, cost:70000000000000000000000, required: 300, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:424, sort: "building", name: "Massive Faucet", filename: "upgrades", cx:-60 , cy:-1620, cost:7000000000000000000000000, required: 350, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	{id:425, sort: "building", name: "Gigantic Faucet", filename: "upgrades", cx:-120 , cy:-1620, cost:700000000000000000000000000, required: 400, effecton: "Faucet", effect: 5, multiplier: 2, perc: 0,  other: 0, description:"每个水龙头将产生两倍的水滴。"},
	
	{id:426, sort: "building", name: "Colossal Garden Hose", filename: "upgrades", cx:-180 , cy:-1620, cost:1000000000000000000000000, required: 300, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:427, sort: "building", name: "Massive Garden Hose", filename: "upgrades", cx:-240 , cy:-1620, cost:100000000000000000000000000, required: 350, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	{id:428, sort: "building", name: "Gigantic Garden Hose", filename: "upgrades", cx:-300 , cy:-1620, cost:10000000000000000000000000000, required: 400, effecton: "Garden hose", effect: 6, multiplier: 2, perc: 0,  other: 0, description:"每个花园软管将产生两倍的水滴。"},
	
	{id:429, sort: "building", name: "Colossal Truck", filename: "upgrades", cx:-360 , cy:-1620, cost:16500000000000000000000000, required: 300, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:430, sort: "building", name: "Massive Truck", filename: "upgrades", cx:-420 , cy:-1620, cost:1650000000000000000000000000, required: 350, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	{id:431, sort: "building", name: "Gigantic Truck", filename: "upgrades", cx:-480 , cy:-1620, cost:165000000000000000000000000000, required: 400, effecton: "Truck", effect: 7, multiplier: 2, perc: 0,  other: 0, description:"每辆卡车将产生两倍的水滴。"},
	
	{id:432, sort: "building", name: "Colossal Fire Hose", filename: "upgrades", cx:0 , cy:-1680, cost:255000000000000000000000000, required: 300, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:433, sort: "building", name: "Massive Fire Hose", filename: "upgrades", cx:-60 , cy:-1680, cost:25500000000000000000000000000, required: 350, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	{id:434, sort: "building", name: "Gigantic Fire Hose", filename: "upgrades", cx:-120 , cy:-1680, cost:2550000000000000000000000000000, required: 400, effecton: "Fire hose", effect: 8, multiplier: 2, perc: 0,  other: 0, description:"每个消防水带将产生两倍的水滴。"},
	
	{id:435, sort: "building", name: "Colossal Mine", filename: "upgrades", cx:-180 , cy:-1680, cost:3750000000000000000000000000, required: 300, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:436, sort: "building", name: "Massive Mine", filename: "upgrades", cx:-240 , cy:-1680, cost:375000000000000000000000000000, required: 350, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	{id:437, sort: "building", name: "Gigantic Mine", filename: "upgrades", cx:-300 , cy:-1680, cost:37500000000000000000000000000000, required: 400, effecton: "Ice mine", effect: 9, multiplier: 2, perc: 0,  other: 0, description:"每个冰矿将产生两倍的水滴。"},
	
	{id:438, sort: "building", name: "Colossal Spaceship", filename: "upgrades", cx:-360 , cy:-1680, cost:50000000000000000000000000000, required: 300, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:439, sort: "building", name: "Massive Spaceship", filename: "upgrades", cx:-420 , cy:-1680, cost:5000000000000000000000000000000, required: 350, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	{id:440, sort: "building", name: "Gigantic Spaceship", filename: "upgrades", cx:-480 , cy:-1680, cost:500000000000000000000000000000000, required: 400, effecton: "Spaceship", effect: 10, multiplier: 2, perc: 0,  other: 0, description:"每个太空飞船将产生两倍的水滴。"},
	
	{id:441, sort: "building", name: "Colossal Wormhole", filename: "upgrades", cx:0 , cy:-1740, cost:700000000000000000000000000000, required: 300, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:442, sort: "building", name: "Massive Wormhole", filename: "upgrades", cx:-60 , cy:-1740, cost:70000000000000000000000000000000, required: 350, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	{id:443, sort: "building", name: "Gigantic Wormhole", filename: "upgrades", cx:-120 , cy:-1740, cost:7000000000000000000000000000000000, required: 400, effecton: "Wormhole", effect: 11, multiplier: 2, perc: 0,  other: 0, description:"每个虫洞将产生两倍的水滴。"},
	
	{id:444, sort: "building", name: "Colossal River", filename: "upgrades", cx:-180 , cy:-1740, cost:8500000000000000000000000000000, required: 300, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:445, sort: "building", name: "Massive River", filename: "upgrades", cx:-240 , cy:-1740, cost:850000000000000000000000000000000, required: 350, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	{id:446, sort: "building", name: "Gigantic River", filename: "upgrades", cx:-300 , cy:-1740, cost:85000000000000000000000000000000000, required: 400, effecton: "River", effect: 12, multiplier: 2, perc: 0,  other: 0, description:"每条河流将产生两倍的水滴。"},
	
	{id:447, sort: "building", name: "Colossal Collider", filename: "upgrades", cx:-360 , cy:-1740, cost:105000000000000000000000000000000, required: 300, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:448, sort: "building", name: "Massive Collider", filename: "upgrades", cx:-420 , cy:-1740, cost:10500000000000000000000000000000000, required: 350, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"},
	{id:449, sort: "building", name: "Gigantic Collider", filename: "upgrades", cx:-480 , cy:-1740, cost:1050000000000000000000000000000000000, required: 400, effecton: "Large H-O collider", effect: 13, multiplier: 2, perc: 0,  other: 0, description:"每个大型H-O碰撞机都会产生两倍的水滴。"}

	//{id:450, sort: "switch", name: "Cloud switch", filename: "upgrades", cx:-480 , cy:-300, cost:100000000000000, required: 1, effecton: 0, effect: 0, multiplier: 0, perc: 0,  other: 0, description:"Unlocks a switch that lets you toggle between having clouds and a drops per second boost."},
	
	
];

var _achievements = [
	{sort: "drops", name: "Make one drop", filename: "achievements", cx:0, cy:0, required: 1, description:"制造1水滴"},
	{sort: "drops", name: "Make a thousand drops", filename: "achievements", cx:-60, cy:0,  required: 1000, description:"制造1000水滴"},
	{sort: "drops", name: "Make 100,000 drops", filename: "achievements", cx:-120, cy:0,  required: 100000, description:"制造100000水滴"},
	{sort: "drops", name: "Make a million drops", filename: "achievements", cx:-180, cy:0,  required: 1000000, description:"制造1000000水滴"},
	{sort: "drops", name: "Make a 100 million drops", filename: "achievements", cx:-240, cy:0,  required: 100000000, description:"制造100000000水滴"},
	{sort: "drops", name: "Make a billion drops", filename: "achievements", cx:-300, cy:0,  required: 1000000000, description:"制造1000000000水滴"},
	{sort: "drops", name: "Make a 100 billion drops", filename: "achievements", cx:-360, cy:0,  required: 100000000000, description:"制造100000000000水滴"},
	{sort: "drops", name: "Make a trillion drops", filename: "achievements", cx:-420, cy:0,  required: 1000000000000, description:"制造1000000000000水滴"},
	{sort: "drops", name: "Make a 100 trillion drops", filename: "achievements", cx:0, cy:-60,  required: 100000000000000, description:"制造100000000000000水滴"},
	{sort: "drops", name: "Make a quadrillion drops", filename: "achievements", cx:-60, cy:-60,  required: 1000000000000000, description:"制造1000000000000000水滴"},
	{sort: "drops", name: "Make a 100 quadrillion drops", filename: "achievements", cx:-120, cy:-60,  required: 100000000000000000, description:"制造100000000000000000水滴"},
	{sort: "drops", name: "Make a quintillion drops", filename: "achievements", cx:-180, cy:-60,  required: 1000000000000000000, description:"制造1000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 quintillion drops", filename: "achievements", cx:-240, cy:-60,  required: 100000000000000000000, description:"制造100000000000000000000水滴"},
	{sort: "drops", name: "Make a sextillion drops", filename: "achievements", cx:-300, cy:-60,  required: 1000000000000000000000, description:"制造1000000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 sextillion drops", filename: "achievements", cx:-360, cy:-60,  required: 100000000000000000000000, description:"制造100000000000000000000000水滴"},
	{sort: "drops", name: "Make a septillion drops", filename: "achievements", cx:-420, cy:-60,  required: 1000000000000000000000000, description:"制造1000000000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 septillion drops", filename: "achievements", cx:0, cy:-120,  required: 100000000000000000000000000, description:"制造100000000000000000000000000水滴"},
	{sort: "drops", name: "Make an octillion drops", filename: "achievements", cx:-60, cy:-120,  required: 1000000000000000000000000000, description:"制造1000000000000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 octillion drops", filename: "achievements", cx:-120, cy:-120,  required: 100000000000000000000000000000, description:"制造100000000000000000000000000000水滴"},
	{sort: "drops", name: "Make a nonillion drops", filename: "achievements", cx:-180, cy:-120,  required: 1000000000000000000000000000000, description:"制造1000000000000000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 nonillion drops", filename: "achievements", cx:-240, cy:-120,  required: 100000000000000000000000000000000, description:"制造100000000000000000000000000000000水滴"},
	{sort: "drops", name: "Make a decillion drops", filename: "achievements", cx:-300, cy:-120,  required: 1000000000000000000000000000000000, description:"制造1000000000000000000000000000000000水滴"},
	{sort: "drops", name: "Make a 100 decillion drops", filename: "achievements", cx:-360, cy:-120,  required: 100000000000000000000000000000000000, description:"制造100000000000000000000000000000000000水滴"},
	
	{sort: "persecond", name: "Newborn", filename: "achievements", cx:0, cy:0,  required: 1, description:"每秒制造1水滴"},
	{sort: "persecond", name: "Baby", filename: "achievements", cx:-60, cy:0,  required: 10, description:"每秒制造10水滴"},
	{sort: "persecond", name: "Toddler", filename: "achievements", cx:-120, cy:0,  required: 100, description:"每秒制造100水滴"},
	{sort: "persecond", name: "Gradeschooler", filename: "achievements", cx:-180, cy:0,  required: 1000, description:"每秒制造1000水滴"},
	{sort: "persecond", name: "Teen", filename: "achievements", cx:-240, cy:0,  required: 10000, description:"每秒制造10000水滴"},
	{sort: "persecond", name: "Young adult", filename: "achievements", cx:-300, cy:0,  required: 100000, description:"每秒制造100000水滴"},
	{sort: "persecond", name: "Student", filename: "achievements", cx:-360, cy:0,  required: 1000000, description:"每秒制造1000000水滴"},
	{sort: "persecond", name: "College student", filename: "achievements", cx:-420, cy:0,  required: 10000000, description:"每秒制造10000000水滴"},
	{sort: "persecond", name: "Undergraduate", filename: "achievements", cx:0, cy:-60,  required: 100000000, description:"每秒制造100000000水滴"},
	{sort: "persecond", name: "Bachelor", filename: "achievements", cx:-60, cy:-60,  required: 1000000000, description:"每秒制造1000000000水滴"},
	{sort: "persecond", name: "Graduate", filename: "achievements", cx:-120, cy:-60,  required: 10000000000, description:"每秒制造10000000000水滴"},
	{sort: "persecond", name: "Master", filename: "achievements", cx:-180, cy:-60,  required: 100000000000, description:"每秒制造100000000000水滴"},
	{sort: "persecond", name: "Postgraduate", filename: "achievements", cx:-240, cy:-60,  required: 1000000000000, description:"每秒制造1000000000000水滴"},
	{sort: "persecond", name: "Intern", filename: "achievements", cx:-300, cy:-60,  required: 10000000000000, description:"每秒制造10000000000000水滴"},
	{sort: "persecond", name: "Entry level job", filename: "achievements", cx:-360, cy:-60,  required: 100000000000000, description:"每秒制造100000000000000水滴"},
	{sort: "persecond", name: "Middle level job", filename: "achievements", cx:-420, cy:-60,  required: 1000000000000000, description:"每秒制造1000000000000000水滴"},
	{sort: "persecond", name: "Chief Sales Officer", filename: "achievements", cx:0, cy:-120,  required: 10000000000000000, description:"每秒制造10000000000000000水滴"},
	{sort: "persecond", name: "Chief Information Officer", filename: "achievements", cx:-60, cy:-120,  required: 100000000000000000, description:"每秒制造100000000000000000水滴"},
	{sort: "persecond", name: "Chief Operations Officer", filename: "achievements", cx:-120, cy:-120,  required: 1000000000000000000, description:"每秒制造1000000000000000000水滴"},
	{sort: "persecond", name: "Chief Financial Officer", filename: "achievements", cx:-180, cy:-120,  required: 10000000000000000000, description:"每秒制造10000000000000000000水滴"},
	{sort: "persecond", name: "Chief Executive Officer", filename: "achievements", cx:-240, cy:-120,  required: 100000000000000000000, description:"每秒制造100000000000000000000水滴"},
	...
	{sort: "helpinghand", name: "An extra hand", filename: "upgrades", cx:0, cy:-60,  required: 1, description:"拥有 1 Helping hand"},
	{sort: "helpinghand", name: "Injury prevention", filename: "upgrades", cx:-60, cy:-60,  required: 50, description:"拥有 50 Helping hands"},
	{sort: "helpinghand", name: "Clicking With All Fingers and ten hands", filename: "upgrades", cx:-120, cy:-60,  required: 100, description:"拥有 100 Helping hands"},
	{sort: "helpinghand", name: "A Lot Of Fingers", filename: "upgrades", cx:-180, cy:-60,  required: 150, description:"拥有 150 Helping hands"},
	{sort: "helpinghand", name: "Even More Fingers", filename: "upgrades", cx:-240, cy:-60,  required: 200, description:"拥有 200 Helping hands"},
	{sort: "helpinghand", name: "Where do you get all these hands?", filename: "upgrades", cx:-300, cy:-60,  required: 250, description:"拥有 250 Helping hands"},
	{sort: "helpinghand", name: "Is it even possible to get more?", filename: "upgrades", cx:-360, cy:-60,  required: 300, description:"拥有 300 Helping hands"},
	{sort: "helpinghand", name: "I guess it is.", filename: "upgrades", cx:-420, cy:-60,  required: 400, description:"拥有 400 Helping hands"},
	
	{sort: "pipette", name: "1", filename: "upgrades", cx:0, cy:-120,  required: 1, description:"拥有 1 pipette"},
	{sort: "pipette", name: "50", filename: "upgrades", cx:-60, cy:-120,  required: 50, description:"拥有 50 pipettes"},
	{sort: "pipette", name: "100", filename: "upgrades", cx:-120, cy:-120,  required: 100, description:"拥有 100 pipettes"},
	{sort: "pipette", name: "150", filename: "upgrades",  cx:-180, cy:-120, required: 150, description:"拥有 150 pipettes"},
	{sort: "pipette", name: "200", filename: "upgrades", cx:-240, cy:-120,  required: 200, description:"拥有 200 pipettes"},
	{sort: "pipette", name: "250", filename: "upgrades", cx:-300, cy:-120,  required: 250, description:"拥有 250 pipettes"},
	{sort: "pipette", name: "300", filename: "upgrades", cx:-360, cy:-120,  required: 300, description:"拥有 300 pipettes"},
	{sort: "pipette", name: "400", filename: "upgrades", cx:-420, cy:-120, required: 400, description:"拥有 400 pipettes"},
	
	{sort: "airdryer", name: "1", filename: "upgrades", cx:0, cy:-180,  required: 1, description:"拥有 1 air dryer"},
	{sort: "airdryer", name: "50", filename: "upgrades", cx:-60, cy:-180,  required: 50, description:"拥有 50 air dryers"},
	{sort: "airdryer", name: "100", filename: "upgrades", cx:-120, cy:-180,  required: 100, description:"拥有 100 air dryers"},
	{sort: "airdryer", name: "150", filename: "upgrades", cx:-180, cy:-180,  required: 150, description:"拥有 150 air dryers"},
	{sort: "airdryer", name: "200", filename: "upgrades", cx:-240, cy:-180,  required: 200, description:"拥有 200 air dryers"},
	{sort: "airdryer", name: "250", filename: "upgrades", cx:-300, cy:-180,  required: 250, description:"拥有 250 air dryers"},
	{sort: "airdryer", name: "300", filename: "upgrades", cx:-360, cy:-180,  required: 300, description:"拥有 300 air dryers"},
	{sort: "airdryer", name: "400", filename: "upgrades", cx:-240, cy:-180,  required: 400, description:"拥有 400 air dryers"},

	{sort: "bucket", name: "1", filename: "upgrades", cx:0, cy:-240,  required: 1, description:"拥有 1 bucket"},
	{sort: "bucket", name: "50", filename: "upgrades", cx:-60, cy:-240, required: 50, description:"拥有 50 buckets"},
	{sort: "bucket", name: "100", filename: "upgrades", cx:-120, cy:-240,  required: 100, description:"拥有 100 buckets"},
	{sort: "bucket", name: "150", filename: "upgrades", cx:-180, cy:-240,  required: 150, description:"拥有 150 buckets"},
	{sort: "bucket", name: "200", filename: "upgrades", cx:-240, cy:-240,  required: 200, description:"拥有 200 buckets"},
	{sort: "bucket", name: "250", filename: "upgrades", cx:-300, cy:-240,  required: 250, description:"拥有 250 buckets"},
	{sort: "bucket", name: "300", filename: "upgrades", cx:-360, cy:-240,  required: 300, description:"拥有 300 buckets"},
	{sort: "bucket", name: "400", filename: "upgrades", cx:-420, cy:-240,  required: 400, description:"拥有 400 buckets"},

	{sort: "raindance", name: "1", filename: "upgrades", cx:0, cy:-300,  required: 1, description:"拥有 1 祈雨舞"},
	{sort: "raindance", name: "50", filename: "upgrades", cx:-60, cy:-300,  required: 50, description:"拥有 50 祈雨舞"},
	{sort: "raindance", name: "100", filename: "upgrades", cx:-120, cy:-300,  required: 100, description:"拥有 100 祈雨舞"},
	{sort: "raindance", name: "150", filename: "upgrades", cx:-180, cy:-300,  required: 150, description:"拥有 150 祈雨舞"},
	{sort: "raindance", name: "200", filename: "upgrades", cx:-240, cy:-300,  required: 200, description:"拥有 200 祈雨舞"},
	{sort: "raindance", name: "250", filename: "upgrades", cx:-300, cy:-300,  required: 250, description:"拥有 250 祈雨舞"},
	{sort: "raindance", name: "300", filename: "upgrades", cx:-360, cy:-300,  required: 300, description:"拥有 300 祈雨舞"},
	{sort: "raindance", name: "400", filename: "upgrades", cx:-420, cy:-300,  required: 400, description:"拥有 400 祈雨舞"},
	
	{sort: "faucet", name: "1", filename: "upgrades", cx:0, cy:-360,  required: 1, description:"拥有 1 水龙头"},
	{sort: "faucet", name: "50", filename: "upgrades", cx:-60, cy:-360,  required: 50, description:"拥有 50 水龙头"},
	{sort: "faucet", name: "100", filename: "upgrades", cx:-120, cy:-360,  required: 100, description:"拥有 100 水龙头"},
	{sort: "faucet", name: "150", filename: "upgrades", cx:-180, cy:-360,  required: 150, description:"拥有 150 水龙头"},
	{sort: "faucet", name: "200", filename: "upgrades", cx:-240, cy:-360,  required: 200, description:"拥有 200 水龙头"},
	{sort: "faucet", name: "250", filename: "upgrades", cx:-300, cy:-360,  required: 250, description:"拥有 250 水龙头"},
	{sort: "faucet", name: "300", filename: "upgrades", cx:-360, cy:-360,  required: 300, description:"拥有 300 水龙头"},
	{sort: "faucet", name: "400", filename: "upgrades", cx:-420, cy:-360,  required: 400, description:"拥有 400 水龙头"},
	
	{sort: "gardenhose", name: "1", filename: "upgrades", cx:0, cy:-420,  required: 1, description:"拥有 1 花园软管"},
	{sort: "gardenhose", name: "50", filename: "upgrades", cx:-60, cy:-420,  required: 50, description:"拥有 50 花园软管"},
	{sort: "gardenhose", name: "100", filename: "upgrades", cx:-120, cy:-420,  required: 100, description:"拥有 100 花园软管"},
	{sort: "gardenhose", name: "150", filename: "upgrades", cx:-180, cy:-420,  required: 150, description:"拥有 150 花园软管"},
	{sort: "gardenhose", name: "200", filename: "upgrades", cx:-240, cy:-420,  required: 200, description:"拥有 200 花园软管"},
	{sort: "gardenhose", name: "250", filename: "upgrades", cx:-300, cy:-420,  required: 250, description:"拥有 250 花园软管"},
	{sort: "gardenhose", name: "300", filename: "upgrades", cx:-360, cy:-420,  required: 300, description:"拥有 300 花园软管"},
	{sort: "gardenhose", name: "400", filename: "upgrades", cx:-420, cy:-420,  required: 400, description:"拥有 400 花园软管"},

	{sort: "truck", name: "1", filename: "upgrades", cx:0, cy:-480,  required: 1, description:"拥有 1 卡车"},
	{sort: "truck", name: "50", filename: "upgrades", cx:-60, cy:-480,  required: 50, description:"拥有 50 卡车"},
	{sort: "truck", name: "100", filename: "upgrades", cx:-120, cy:-480,  required: 100, description:"拥有 100 卡车"},
	{sort: "truck", name: "150", filename: "upgrades", cx:-180, cy:-480,  required: 150, description:"拥有 150 卡车"},
	{sort: "truck", name: "200", filename: "upgrades", cx:-240, cy:-480,  required: 200, description:"拥有 200 卡车"},
	{sort: "truck", name: "250", filename: "upgrades", cx:-300, cy:-480,  required: 250, description:"拥有 250 卡车"},
	{sort: "truck", name: "300", filename: "upgrades", cx:-360, cy:-480,  required: 300, description:"拥有 300 卡车"},
	{sort: "truck", name: "400", filename: "upgrades", cx:-420, cy:-480,  required: 400, description:"拥有 400 卡车"},

	{sort: "firehose", name: "1", filename: "upgrades", cx:0, cy:-540,  required: 1, description:"拥有 1 消防水带"},
	{sort: "firehose", name: "50", filename: "upgrades", cx:-60, cy:-540,  required: 50, description:"拥有 50 消防水带"},
	{sort: "firehose", name: "100", filename: "upgrades", cx:-120, cy:-540,  required: 100, description:"拥有 100 消防水带"},
	{sort: "firehose", name: "150", filename: "upgrades", cx:-180, cy:-540,  required: 150, description:"拥有 150 消防水带"},
	{sort: "firehose", name: "200", filename: "upgrades", cx:-240, cy:-540,  required: 200, description:"拥有 200 消防水带"},
	{sort: "firehose", name: "250", filename: "upgrades", cx:-300, cy:-540,  required: 250, description:"拥有 250 消防水带"},
	{sort: "firehose", name: "300", filename: "upgrades", cx:-360, cy:-540,  required: 300, description:"拥有 300 消防水带"},
	{sort: "firehose", name: "400", filename: "upgrades", cx:-420, cy:-540,  required: 400, description:"拥有 400 消防水带"},
	
	{sort: "icemining", name: "1", filename: "upgrades", cx:0, cy:-600,  required: 1, description:"拥有 1 冰矿"},
	{sort: "icemining", name: "50", filename: "upgrades", cx:-60, cy:-600,  required: 50, description:"拥有 50 冰矿"},
	{sort: "icemining", name: "100", filename: "upgrades", cx:-120, cy:-600,  required: 100, description:"拥有 100 冰矿"},
	{sort: "icemining", name: "150", filename: "upgrades", cx:-180, cy:-600,  required: 150, description:"拥有 150 冰矿"},
	{sort: "icemining", name: "200", filename: "upgrades", cx:-240, cy:-600,  required: 200, description:"拥有 200 冰矿"},
	{sort: "icemining", name: "250", filename: "upgrades", cx:-300, cy:-600,  required: 250, description:"拥有 250 冰矿"},
	{sort: "icemining", name: "300", filename: "upgrades", cx:-360, cy:-600,  required: 300, description:"拥有 300 冰矿"},
	{sort: "icemining", name: "400", filename: "upgrades", cx:-420, cy:-600,  required: 400, description:"拥有 400 冰矿"},
	
	{sort: "spaceship", name: "1", filename: "upgrades", cx:0, cy:-660,  required: 1, description:"拥有 1 飞船"},
	{sort: "spaceship", name: "50", filename: "upgrades", cx:-60, cy:-660,  required: 50, description:"拥有 50 飞船"},
	{sort: "spaceship", name: "100", filename: "upgrades", cx:-120, cy:-660,  required: 100, description:"拥有 100 飞船"},
	{sort: "spaceship", name: "150", filename: "upgrades", cx:-180, cy:-660,  required: 150, description:"拥有 150 飞船"},
	{sort: "spaceship", name: "200", filename: "upgrades", cx:-240, cy:-660,  required: 200, description:"拥有 200 飞船"},
	{sort: "spaceship", name: "250", filename: "upgrades", cx:-300, cy:-660,  required: 250, description:"拥有 250 飞船"},
	{sort: "spaceship", name: "300", filename: "upgrades", cx:-360, cy:-660,  required: 300, description:"拥有 300 飞船"},
	{sort: "spaceship", name: "400", filename: "upgrades", cx:-420, cy:-660,  required: 400, description:"拥有 400 飞船"},
	
	{sort: "wormhole", name: "1", filename: "upgrades", cx:0, cy:-720,  required: 1, description:"拥有 1 虫洞"},
	{sort: "wormhole", name: "50", filename: "upgrades", cx:-60, cy:-720,  required: 50, description:"拥有 50 虫洞"},
	{sort: "wormhole", name: "100", filename: "upgrades", cx:-120, cy:-720,  required: 100, description:"拥有 100 虫洞"},
	{sort: "wormhole", name: "150", filename: "upgrades", cx:-180, cy:-720,  required: 150, description:"拥有 150 虫洞"},
	{sort: "wormhole", name: "200", filename: "upgrades", cx:-240, cy:-720,  required: 200, description:"拥有 200 虫洞"},
	{sort: "wormhole", name: "250", filename: "upgrades", cx:-300, cy:-720,  required: 250, description:"拥有 250 虫洞"},
	{sort: "wormhole", name: "300", filename: "upgrades", cx:-360, cy:-720,  required: 300, description:"拥有 300 虫洞"},
	{sort: "wormhole", name: "400", filename: "upgrades", cx:-420, cy:-720,  required: 400, description:"拥有 400 虫洞"},
	
	{sort: "river", name: "1", filename: "upgrades", cx:0, cy:-780,  required: 1, description:"拥有 1 河流"},
	{sort: "river", name: "50", filename: "upgrades", cx:-60, cy:-780,  required: 50, description:"拥有 50 河流"},
	{sort: "river", name: "100", filename: "upgrades", cx:-120, cy:-780,  required: 100, description:"拥有 100 河流"},
	{sort: "river", name: "150", filename: "upgrades", cx:-180, cy:-780,  required: 150, description:"拥有 150 河流"},
	{sort: "river", name: "200", filename: "upgrades", cx:-240, cy:-780,  required: 200, description:"拥有 200 河流"},
	{sort: "river", name: "250", filename: "upgrades", cx:-300, cy:-780,  required: 250, description:"拥有 250 河流"},
	{sort: "river", name: "300", filename: "upgrades", cx:-360, cy:-780,  required: 300, description:"拥有 300 河流"},
	{sort: "river", name: "400", filename: "upgrades", cx:-420, cy:-780,  required: 400, description:"拥有 400 河流"},
	
	{sort: "collider", name: "1", filename: "upgrades", cx:0, cy:-840,  required: 1, description:"拥有 1 大型H-O碰撞机"},
	{sort: "collider", name: "50", filename: "upgrades", cx:-60, cy:-840,  required: 50, description:"拥有 50 大型H-O碰撞机"},
	{sort: "collider", name: "100", filename: "upgrades", cx:-120, cy:-840,  required: 100, description:"拥有 100 大型H-O碰撞机"},
	{sort: "collider", name: "150", filename: "upgrades", cx:-180, cy:-840,  required: 150, description:"拥有 150 大型H-O碰撞机"},
	{sort: "collider", name: "200", filename: "upgrades", cx:-240, cy:-840,  required: 200, description:"拥有 200 大型H-O碰撞机"},
	{sort: "collider", name: "250", filename: "upgrades", cx:-300, cy:-840,  required: 250, description:"拥有 250 大型H-O碰撞机"},
	{sort: "collider", name: "300", filename: "upgrades", cx:-360, cy:-840,  required: 300, description:"拥有 300 大型H-O碰撞机"},
	{sort: "collider", name: "400", filename: "upgrades", cx:-420, cy:-840,  required: 400, description:"拥有 400 大型H-O碰撞机"},
	
	{sort: "totalbuildings", name: "Amateur builder", filename: "achievements", cx:-420, cy:-120,  required:100 , description:"拥有 100 buildings in total."},
	{sort: "totalbuildings", name: "Contractor", filename: "achievements", cx:-480, cy:0,  required:500 , description:"拥有 500 buildings in total."},
	{sort: "totalbuildings", name: "City developer", filename: "achievements", cx:-480, cy:-60,  required:1000 , description:"拥有 1000 buildings in total."},
	{sort: "totalbuildings", name: "Building God", filename: "achievements", cx:-480, cy:-120,  required:1500 , description:"拥有 1500 buildings in total."},
	...
	{sort: "totalupgrades", name: "Upgrading started", filename: "upgrades", cx:-0, cy:-1380,  required: 1, other: 0, description:"拥有 one upgrade."},
	{sort: "totalupgrades", name: "Enhance further!", filename: "upgrades", cx:-60, cy:-1380,  required: 20, other: 0, description:"拥有 20 upgrades."},
	{sort: "totalupgrades", name: "Upgrading has become quite a hobby.", filename: "upgrades", cx:-120, cy:-1380,  required: 50, other: 0, description:"拥有 50 upgrades."},
	{sort: "totalupgrades", name: "Haven't you got enough upgrades?", filename: "upgrades", cx:-180, cy:-1380,  required: 100, other: 0, description:"拥有 100 upgrades."},
	{sort: "totalupgrades", name: "Professional upgrader", filename: "upgrades", cx:-240, cy:-1380,  required: 150, other: 0, description:"拥有 150 upgrades."},
	{sort: "totalupgrades", name: "Upgrading God", filename: "upgrades", cx:-300, cy:-1380,  required: 200, other: 0, description:"拥有 200 upgrades."},
